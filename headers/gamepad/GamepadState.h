...
#define GAMEPAD_MASK_DOWN_LEFT    (GAMEPAD_MASK_DOWN | GAMEPAD_MASK_LEFT)
#define GAMEPAD_MASK_DOWN_RIGHT  (GAMEPAD_MASK_DOWN | GAMEPAD_MASK_RIGHT)
#define GAMEPAD_MASK_UP_LEFT  (GAMEPAD_MASK_UP | GAMEPAD_MASK_LEFT)
#define GAMEPAD_MASK_UP_RIGHT (GAMEPAD_MASK_UP | GAMEPAD_MASK_RIGHT)
